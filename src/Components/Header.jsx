...
const Header = () => {
  ...
  return (
    <div >
        <img onClick={()=>navigate("/home")} style={{width:"120px",height:"60px",marginLeft:'45%',marginTop:"50px",cursor:'pointer'}} src="https://miro.medium.com/max/1400/1*qzSi1lZx-4Y733QbDw-h1w.png" alt=""  className='cursor-Pointer'/>
